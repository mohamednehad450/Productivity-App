...
const ThemeSettingsInput: FC<ThemeSettingsInputProps> = ({
  themeSettings,
  onChange,
}) => {
  return (
    <div className="settings-container">
      <span className="settings-header">Theme Settings</span>
      <SettingRow title="Dark Mode?">
        <Checkbox
          checked={themeSettings.theme === "dark"}
          onChange={(dark) =>
            onChange({ ...themeSettings, theme: dark ? "dark" : "light" })
          }
        />
      </SettingRow>
      <SettingRow title="Solar?">
        <Checkbox
