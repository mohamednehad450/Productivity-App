...
const TodosSettingsInput: FC<TodosSettingsInputProps> = ({ todoSettings, onChange }) => {
    ...
    return (
        <div className="settings-container">
            ...
            <SettingRow
                title="Hide Checked Todos?"
            >
                <Checkbox
                    checked={todoSettings.hideCheckedTodos}
                    onChange={hideCheckedTodos => onChange({ ...todoSettings, hideCheckedTodos })}
                />
            </SettingRow>
            <SettingRow
                title="Sort Todos By"
            >
                <div className="setting-row align-center">
                    <Select
                        ...
                        selected={{ id: todoSettings.sortTodosBy, label: SortLabel[todoSettings.sortTodosBy] }}
                    ...
                    <Checkbox
                        ...
                        onChange={todosAscending => onChange({ ...todoSettings, todosAscending })}
                    />
                </div>
            ...
            >
                <div className="setting-row align-center">
                    ...
                    <Select
                        ...
                        selected={{ id: todoSettings.sortStepsBy, label: SortLabel[todoSettings.sortStepsBy] }}
                    ...
                    <Checkbox
                        ...
                        onChange={stepsAscending => onChange({ ...todoSettings, stepsAscending })}
                    />
                </div>
            </SettingRow>
        </div>
