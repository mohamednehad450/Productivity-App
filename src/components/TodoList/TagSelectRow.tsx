...
const TagSelectRow: FC<TagSelectRowProps> = ({ tag, isSelected, onClick, }) => {
    ...
    return (
        <>
            ...
            <span
                className={`${isSelected ? 'select-item-selected' : ''} tag-select-container select-item`}
                onClick={onClick}
            >
                <button
                    className={`tag-select-item iconbutton`}
                >
                ...
                <span className="tag-select-actions">
                    <button
                        onClick={(e) => { e.stopPropagation(); setEditTag(true) }}
